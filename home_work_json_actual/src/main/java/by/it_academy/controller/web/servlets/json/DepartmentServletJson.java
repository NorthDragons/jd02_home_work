package by.it_academy.controller.web.servlets.json;/* created by Kaminskii Ivan
 */
...
@WebServlet(name = "json", urlPatterns = "/departmentJson")
public class DepartmentServletJson extends HttpServlet {
    private static IDepartmentService departmentService;

    public DepartmentServletJson() {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        switch (get_mode) {
            ...
            case ("all"):
                ...
                Collection<Department> departments = departmentService.getAllDepartment(limit, page);
